...
public class RealizarPago extends JPanel {
	...
	public RealizarPago() {
		...
		comboBox.setBounds(399, 496, 346, 39);
		panel.add(comboBox);
		
		JLabel lblNewLabel_2 = new JLabel("Tarifa Actual:");
		lblNewLabel_2.setFont(new Font("Arial", Font.BOLD, 24));
		lblNewLabel_2.setBounds(240, 496, 172, 46);
		panel.add(lblNewLabel_2);
		
		JButton btnNewButton_1 = new JButton("Confirmar");
		btnNewButton_1.setFont(new Font("Arial", Font.BOLD, 24));
		btnNewButton_1.setBounds(500, 630, 200, 51);
		panel.add(btnNewButton_1);
		
		JLabel Tarifas = new JLabel("");
		Tarifas.setIcon(new ImageIcon(Util.resizeImage(1200, 302, Util.getStream("main/resources/tarifas.png"))));
		Tarifas.setBounds(0, 22, 1200, 302);
		panel.add(Tarifas);
