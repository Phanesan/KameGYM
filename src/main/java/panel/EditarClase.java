...
public class EditarClase extends JPanel {
	...
	public EditarClase(Main main) {
		...
		lblImage.setIcon(new ImageIcon(Util.resizeImage(390, 800, Util.getStream("main/resources/image2.png"))));
		add(lblImage);
		
		JButton btn = new JButton("Actualizar");
		btn.setFont(new Font("Arial", Font.BOLD, 32));
		btn.setBounds(262, 617, 220, 55);
		add(btn);
